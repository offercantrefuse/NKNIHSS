...
public class FourOneActivity extends AppCompatActivity {
    int tmp = -1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button7.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v){
                startActivity(new Intent(FourOneActivity.this,PopFourOne.class));
            }
        });
                ...
                new Button.OnClickListener() {
                    public void onClick(View v) {
                        if(tmp==-1) {
                            ...
                            Intent intent = new Intent(v.getContext(), FourTwoActivity.class);
