...
public class SevenTwoActivity extends AppCompatActivity {
    int tmp = -1;
    String limbWeak;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_seven_two);
        ...
        button7.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v){
                startActivity(new Intent(SevenTwoActivity.this,PopSevenTwo.class));
            }
        });
        ...
        button9.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v){
                startActivity(new Intent(SevenTwoActivity.this,PopVideo.class));
            }
        });
