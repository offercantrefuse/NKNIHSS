    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button7.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v){
                startActivity(new Intent(TwoTwoActivity.this,PopTwoTwo.class));
            }
        });
        ...
        button9.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v){
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://youtu.be/DUbx6wrffIQ"));
                ...
                new Button.OnClickListener() {
                    public void onClick(View v) {
                        if(tmp==-1) {
                            ...
                            Intent intent = new Intent(v.getContext(), TwoThreeActivity.class);
